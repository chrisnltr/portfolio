...
function parseHsl(hslStr: string) {
  ...
  if (!match) return { h: 220, s: 75, l: 72 };
  return {
...
.border-glow-card {
  ...
  --cursor-angle: 45deg;
  --edge-sensitivity: 48;
  --color-sensitivity: calc(var(--edge-sensitivity) + 16);
  --border-radius: 14px;
  --glow-padding: 10px;
  --cone-spread: 14;
  ...
  display: grid;
  border: 1px solid rgba(243, 246, 250, 0.14);
  background: var(--card-bg, #0d1524);
  overflow: visible;
  box-shadow:
    0 1px 0 rgba(255, 255, 255, 0.04) inset,
    0 18px 42px rgba(2, 6, 18, 0.45);
}
...
.border-glow-card::before {
  ...
  background:
    linear-gradient(var(--card-bg, #0d1524) 0 100%) padding-box,
...
.border-glow-card > .edge-light::before {
  ...
  border-radius: inherit;
  box-shadow:
    inset 0 0 0 1px var(--glow-color-30),
    0 0 4px 0 var(--glow-color-20);
}
